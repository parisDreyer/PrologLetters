...
from keras.layers import \
    Layer, Dense, LSTM, Embedding, TimeDistributed, Bidirectional, SpatialDropout1D, Input
...
class Sample(Layer):                    # Performs sampling step
...
#    During training, call: K.set_value(kl_layer.weight, new_value): to scale the KL loss term.
#    based on: http: // tiao.io/posts/implementing-variational-autoencoders-in-keras-beyond-the-quickstart-tutorial/
class KLLayer(Layer):
